...
injections = {
    ...
    # ("DV1", 0, "moderate", "elevated"): [50, 32, 32, 34, 34, 12, 12, 12, 2],
    # ("DV1", 10, "moderate", "elevated"): [50, 32, 32, 34, 34, 12 - 10, 12, 12, 2],
    # ("DV1", 20, "moderate", "elevated"): [50, 32, 32, 34, 34, 12 - 20, 12, 12, 2],
    ...
    # ("DV1", 20, "moderate", "normal"): [50, 32, 32, 34, 34, 12 - 20, 12, 12, 5],
