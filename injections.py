...
templates = {
    ...
    # ("normal", "elevated"): [74, 47, 50, -17, -12],
    # ("minor", "elevated"): [70, 45, 48, -15, -10],
    # ("moderate", "elevated"): [50, 32, 34, -12, -8],
    ("profound", "elevated"): [25, 15, 16, -8, -6],
}
...
for injection_location in [None, "DV1"]:
    ...
    for injection_pressure in ([0, 30, 60, 90] if injection_location[0] == "A" else [30]) if injection_location else [0]:
